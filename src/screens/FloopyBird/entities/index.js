...
export default restart => {
    ...
    return {
        ...
        ObstacleTop1: Obstacle(world, 'ObstacleTop1', '#4E9F3D', pipeSizePosA.pipeTop.pos, pipeSizePosA.pipeTop.size),
        ObstacleBottom1: Obstacle(world, 'ObstacleBottom1', 'blue', pipeSizePosA.pipeBottom.pos, pipeSizePosA.pipeBottom.size),

        ObstacleTop2: Obstacle(world, 'ObstacleTop2', '#ED2B2A', pipeSizePosB.pipeTop.pos, pipeSizePosB.pipeTop.size),
